...
if($validator->hasErrors()) {
    ...
    header("Location: ../index.php?p=listados-editar&id=" . $id);
    exit;
}

$listado = (new Listado())->traerPorPk($id);
...
if(!empty($imgMiniatura['tmp_name'])) {
    ...
    $nombreImagen = $listado->getImgMiniatura();
}
...
try {
    ...
    $_SESSION['mensaje_exito'] = "¡Éxito! El instrumento fue editado correctamente.";
    header("Location: ../index.php?p=listados");
    exit;
} catch(PDOException $e) {
    $_SESSION['mensaje_error'] = "¡Ocurrió un error inesperado! El instrumento no pudo ser editado.";
    header("Location: ../index.php?p=listados-editar&id=" . $id);
    exit;
}
