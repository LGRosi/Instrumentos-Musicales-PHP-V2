...
class Autenticacion
{
    ...
    {
        // Para marcar al usuario como autenticado, simplemente vamos a definir una variable de sesión
        // para lograrlo.
        // Generalmente, lo más común es guardar en dicha variable la PK del usuario.
